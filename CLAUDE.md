...
## Agent Image Asset Rule

- Add new image assets in SVG format only.
- Do not add new PNG/JPG/WebP image assets unless the user explicitly approves an exception.
